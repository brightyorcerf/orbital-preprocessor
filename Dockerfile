...
# ── System deps ───────────────────────────────────────────────────────────────
# libgl1-mesa-glx was removed in Debian 12; python:3.10-slim now resolves to
# a trixie base, where the OpenCV runtime deps are libgl1 + libglib2.0-0. The
# -dev variant of libxrender was never needed at runtime either.
